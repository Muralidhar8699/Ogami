                    ...
                    {pDetails?.images?.map((e, index) => {
                        return (
                            <div className="product-imgitem" key={index} onClick={() => setImg(e)}>
                                <img alt="logo" className="pd-img" src={ogamiReactBaseUrl + e} />
                            </div>
                        )
                    })}
                </div>
                <div>
                    <img alt="logo" className="product-img" src={img ? ogamiReactBaseUrl + img : ogamiReactBaseUrl + pDetails?.coverImage} />
                </div>
                                ...
                                return (
                                    <div className="reviews-container" key={i}>
                                        <div className="reviwer-img-div">
                                            <img alt="logo" className="reviewer" src={e?.user?.avatar} />
                                            <span>
